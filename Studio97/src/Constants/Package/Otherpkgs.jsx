export default function PricingGuide() {
    return (
        <section className="w-full min-h-screen bg-white flex justify-center items-center py-10">

            {/* WRAPPER */}
            <div className="w-[90%] grid grid-cols-2 gap-6">

                {/* LEFT CARD */}
                <div className="relative h-screen overflow-hidden bg-black rounded-sm">
                    ...
                    <div className="relative z-10 h-full flex flex-col justify-between px-10 py-12 text-white">
                        ...
                        <p className="text-xs relative top-2 left-3 tracking-widest uppercase">
                            STUDIO 97 PHOTOGRAPHY
                        </p>

                        <div>
                            <h1 className="text-[12vh] relative left-3 leading-tight font-serif">
                                PRICING
                            </h1>
                ...
                <div className="h-full bg-[#1c1c1c] text-white flex flex-col">
                    ...
                    <div className=" h-[80%] " >
                        ...
                        <div className="relative h-[62%]">
                            ...
                            <div className="relative z-10 left-5 h-full flex flex-col items-start justify-center">
                                <h2 className="text-[36px] font-serif tracking-wide">
                                    PACKAGES
                                </h2>
                                <p className="italic uppercase text-sm mt-1">
                                    Personal Photoshoot
                                </p>
                                <p className="italic uppercase text-sm mt-1">
                                    Boys | Girls
                        ...
                        <div className=" h-[40%] grid grid-cols-3 border-t border-[#3a3a3a]">
                            ...
                            <div className="px-4 h-full py-6 flex flex-col justify-between text-center border-r border-[#3a3a3a]">
                                <div className="info">
                                    ...
                                    <h3 className="text-[3vh] tracking-widest text-white/90 font-[font2] relative top-1 mb-4">Birthday Shoot</h3>
                                    <ul className="text-[2.2vh] flex flex-col items-start relative top-2 left-2 space-y-2 opacity-90">
                                        <li>Edited Photos</li>
                                        <li>Captured Pics Not Provided</li>
                                        <li>With Setup</li>
                            ...
                            <div className="px-4 py-6 flex flex-col justify-between text-center border-r border-[#3a3a3a]">
                                <div className="info">
                                    ...
                                    <h3 className="text-[3vh] tracking-widest text-white/90 font-[font2] relative top-1 mb-4">Personal Shoot</h3>
                                    <ul className="text-[2.2vh] flex flex-col items-start relative top-2 left-2 space-y-2 opacity-90">
                                        <li>Edited Photos</li>
                                        <li>Captured Pics Not Provided</li>
                                        <li>Without Setup </li>
