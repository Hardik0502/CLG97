...
const Footer = () => {
  return (
    <div className="bg-linear-to-br from-gray-50 to-gray-100">
      ...
      {/* Footer Component */}
      <footer className="relative bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 text-white h-[80vh] md:h-[40vh] flex items-center">
  ...
  md:top-10">
            ...
            {/* Contact Information */}
            <div className="relative">
              <div className="absolute md:top-0 top-13 left-0">
                <h4 className="text-lg font-[font2] text-slate-100">Get In Touch</h4>
              </div>

              <div className="relative font-[font2] top-[14vh] md:top-10 left-0 right-0">
            ...
            <div className="relative font-[font2] ">
              <div className="absolute md:top-0 top-60 left-0">
  ...
  gap-3">
              ...
              <div className="absolute md:top-[90px] top-83 left-0 right-0">
          ...
          {/* Bottom Bar */}
          <div className="absolute md:left-0 left-10 right-0 md:bottom-0 bottom-5 h-12">
            <div className="absolute
  left-0
  md:top-6
 text-slate-400 text-xm">
  ...
  md:right-0
  bottom-12
  md:bottom-0 flex md:flex-row gap-6 text-sm">
