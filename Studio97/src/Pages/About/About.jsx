...
const AboutPage = () => {
  ...
  const termsAndConditions = [
    {
      ...
      terms: [
        ...
        "Payment can be made via UPI, bank transfer, or card",
  ...
  return (
    <div className="relative top-20 w-full bg-white">
      
      {/* Navbar Space */}
        < Navbar />

      {/* Hero Section */}
      <div className="relative w-full bg-linear-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden">
        ...
        <div className="relative" style={{height: '60vh'}}>
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative text-center" style={{width: '91.666667%', maxWidth: '72rem'}}>
              <div className="relative inline-flex items-center justify-center">
                <div className="relative w-24 h-24 bg-linear-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center">
              ...
              <p className="text-lg text-gray-300 leading-relaxed" style={{maxWidth: '48rem', display: 'inline-block'}}>
      ...
      {/* Our Values Section */}
      <div className="relative w-full bg-linear-to-br from-gray-50 to-white">
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {ourValues.map((value, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="relative bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 group overflow-hidden"
                      style={{border: '2px solid #f3f4f6'}}
                    >
                      <div className="relative h-6"></div>
                      <div className="relative" style={{width: 'calc(100% - 3rem)', left: '1.5rem'}}>
                        <div className="relative inline-flex items-center justify-center w-16 h-16 bg-linear-to-br from-blue-500 to-purple-500 rounded-2xl group-hover:scale-110 transition-transform">
                  ...
                  return (
                    ...
                    >
                      <div 
                        ...
                        onClick={() => setActiveTermIndex(isExpanded ? null : sectionIndex)}
                      >
